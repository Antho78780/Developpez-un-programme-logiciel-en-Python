...
class Views:
    def __init__(self, promptPlayer, promptTournament, promptRounds, phrasing):
        self.promptPlayer = promptPlayer
        self.promptTournament = promptTournament
        self.promptRounds = promptRounds
        self.phrasing = phrasing

    def prompt_userName_player(self):
        return self.promptPlayer.prompt_userName_player(self.promptPlayer.prompt_userName_player)

    def prompt_name_player(self):
        return self.promptPlayer.prompt_name_player(self.promptPlayer.prompt_name_player)

    def prompt_dateBirth_player(self):
        return self.promptPlayer.prompt_dateBirth_player(self.promptPlayer.prompt_dateBirth_player)

    def prompt_sex_player(self):
        return self.promptPlayer.prompt_sex_player(self.promptPlayer.prompt_sex_player)

    def prompt_ranking_player(self):
        return self.promptPlayer.prompt_ranking_player()

    def prompt_name_tournament(self):
        return self.promptTournament.prompt_name_tournament(self.promptTournament.prompt_name_tournament)

    def prompt_lieu_tournament(self):
        return self.promptTournament.prompt_lieu_tournament(self.promptTournament.prompt_lieu_tournament)

    def prompt_date_tournament(self):
        return self.promptTournament.prompt_date_tournament(self.promptTournament.prompt_date_tournament)

    def prompt_time_tournament(self):
        return self.promptTournament.prompt_time_tournament(self.promptTournament.prompt_time_tournament)

    def prompt_heure_start_round(self):
        return self.promptRounds.prompt_heure_start_round()

    def prompt_heure_end_round(self):
        return self.promptRounds.prompt_heure_end_round()

    def prompt_date_start_round(self):
        return self.promptRounds.prompt_date_start_round(self.promptRounds.prompt_date_start_round)

    def prompt_date_end_round(self):
        return self.promptRounds.prompt_date_end_round(self.promptRounds.prompt_date_end_round)

    def prompt_round(self):
        return self.promptRounds.prompt_round()

    def prompt_nRound(self):
        return self.promptRounds.prompt_nround()

    def phrasing_create_tournament(self):
        self.phrasing.phrasing_create_tournament()

    def phrasing_create_player(self):
        self.phrasing.phrasing_create_player()

    def phrasing_none_players(self):
        self.phrasing.phrasing_none_players()

    def phrasing_none_tournaments(self):
        self.phrasing.phrasing_none_tournaments()

    def prompt_phrasing_name_tournament(self):
        self.phrasing.prompt_phrasing_name_tournament()

    def phrasing_tournament(self):
        self.phrasing.phrasing_tournament()
    ...
    def menu_player(menu1, menu2, menu3, menu4):
        ...
        if question == 1:
            ...
            print("[bold red]Information incorrect")
            Views.menu_player(menu1, menu2, menu3, menu4)
    ...
    def menu_tournament(menu1, menu2, menu3, menu4):
        ...
        if question == 1:
            ...
            Views.menu_tournament(menu1, menu2, menu3, menu4)
    ...
    def return_menu(menu, choice_menu):
        ...
        if question == "y" or question == "Y":
            ...
            print("[bold red]Informations incorrect")
            Views.return_menu(menu, choice_menu)
