...
class Tournament:
    ...
    def menu_tournament(self):
        comeRound = round.Round(Rounds, Matchs, PromptPlayer, PromptTournament,
                                PromptRound, TinyDB, Query, Console, Table, self.print, Prompt)
